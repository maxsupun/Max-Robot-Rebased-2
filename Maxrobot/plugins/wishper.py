...
async def wishper_ai(_, The: InlineQuery):
    ...
    if query == '' or len(query) > lengths \
        ...
        content = ("**Send whisper messages through inline mode**\n\n"
                   "Usage: `@TheMaxrobotbot [@username] text`")
        description = "Usage: @TheMaxrobotbot [@username] text"
        button = InlineKeyboardButton(
            "More-Help",
            url="https://t.me/TheMaxrobotbot?start=learn"
        )
...
@TheMaxrobotbot your whisper @username
...
example:- 
@TheMaxrobotbot hello this is a test @maxsupun
